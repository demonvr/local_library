...
urlpatterns = [
    # path('', views.index, name='index')  # определяет url паттерн / либо path либо url
    url(r'^$', views.index, name='index'),
    url(r'^books/$', views.BookListView.as_view(), name='books'),  # обобщенный класс отображения списка
